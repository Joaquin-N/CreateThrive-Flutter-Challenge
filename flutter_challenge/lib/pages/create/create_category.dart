        ...
        BlocListener<CreateCategoryCubit, CreateCategoryState>(
          ...
          listener: (context, state) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(CustomSnackBar(
                text: 'Category ${state.category.name} created'));
          },
        ),
        BlocListener<CreateCategoryCubit, CreateCategoryState>(
          listenWhen: (oldState, newState) =>
              newState is CreateCategoryErrorDuplicated,
          listener: (context, state) {
            tec.clear();
            ScaffoldMessenger.of(context).showSnackBar(CustomSnackBar(
                text:
                    'Could not create. Category ${state.category.name} is already in the list'));
          },
        ),
      ],
                  ...
                  SizedBox(
                    ...
                    child: BlockPicker(
                      ...
                      onColorChanged: (color) =>
                          cubit.update(color: color.value),
                    ),
                  ),
                ],
              ),
